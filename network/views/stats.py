...
from ..dao import daily_report, offer_report, affiliate_report
...
class AffiliatesStatsView(APIView):
    permission_classes = (IsAuthenticated, IsAdminUser,)
    ...
    def get(self, request):
        ...
        data = affiliate_report(request.user.id, start_datetime, end_datetime)
